    ...
    constructor(userDefinedOptions) {
        ...
        this.createPage = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                utils_1.statusLog(logSection, `Setting session cookie using cookie: ${this.cookie}`);
        ...
        this.checkIfLoggedIn = (retry = true) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (isLoggedIn) {
                ...
                utils_1.statusLog(logSection, 'Try to login for get new cookie session.');
                yield page.type('#username', this.options.username);
                yield page.type('#password', this.options.password);
                yield page.click('.login__form_action_container ');
                ...
                ;
                yield this.checkIfLoggedIn(false);
            }
            else {
        ...
        this.run = (profileUrl) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const seeMoreButtonsSelectors = [
                    ...
                    '.pv-about-section .lt-line-clamp__more',
                    '.experience-section .pv-profile-section__see-more-inline'
                ];
                ...
                const rawUserProfileData = yield page.evaluate(() => {
                    ...
                    let description = descriptionElement === null || descriptionElement === void 0 ? void 0 : descriptionElement.textContent;
                    if (!description) {
                        const descriptionElements = document.querySelectorAll('.pv-about__summary-text .lt-line-clamp__line');
                        description = '';
